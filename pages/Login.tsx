...
import { Mail, Lock, Loader2, ArrowRight, UserPlus, Leaf } from 'lucide-react';
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div>
              <div className="flex justify-between items-center mb-3">
                ...
                {isLoginMode && <button type="button" className="text-xs font-black text-gold-500 hover:text-gold-600">Recovery</button>}
              </div>
              <div className="relative group">
