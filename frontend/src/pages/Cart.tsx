...
import { Trash2, ChevronLeft, ArrowRight, ShoppingCart, Plus, Minus, Info, ChevronDown, ChevronUp } from 'lucide-react';
            ...
            <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-sm font-black text-gray-900">Split Delivery Option</p>
                    <p className="text-xs text-gray-500">
                      Choose how many meals arrive Sunday vs Wednesday.
                    </p>
                  </div>
                </div>
                {showSplitInfo ? <ChevronUp className="w-5 h-5 text-gray-400" /> : <ChevronDown className="w-5 h-5 text-gray-400" />}
              </button>
              {showSplitInfo && (
                <div className="px-6 pb-5 text-sm text-gray-600">
                  <div className="grid gap-4 md:grid-cols-2">
                    <div className="bg-gray-50 rounded-xl p-4">
                      <p className="text-xs font-black uppercase tracking-widest text-gray-400 mb-2">Rules</p>
                      <ul className="space-y-2">
                        <li className="flex items-start gap-2">
                          <span className="mt-1 h-2 w-2 rounded-full bg-green-500"></span>
                          Sunday + Wednesday must equal your total quantity.
                        </li>
                        <li className="flex items-start gap-2">
                          <span className="mt-1 h-2 w-2 rounded-full bg-green-500"></span>
                          Split is per meal item and can differ per meal.
                        </li>
                        <li className="flex items-start gap-2">
                          <span className="mt-1 h-2 w-2 rounded-full bg-green-500"></span>
                          Some meals are single-drop only and cannot be split.
                        </li>
                      </ul>
                    </div>
                    <div className="bg-gray-50 rounded-xl p-4">
                      ...
                      <ul className="space-y-2">
                        <li className="flex items-start gap-2">
                          <span className="mt-1 h-2 w-2 rounded-full bg-gold-500"></span>
                          Fresher mid-week meals and better texture.
                        </li>
                        <li className="flex items-start gap-2">
                          <span className="mt-1 h-2 w-2 rounded-full bg-gold-500"></span>
                          Less fridge crowding and easier meal planning.
                        </li>
                        <li className="flex items-start gap-2">
                          <span className="mt-1 h-2 w-2 rounded-full bg-gold-500"></span>
